...
void bn_sum(bignum &dest, const bignum &a, const bignum &b);
...
void bn_trim(bignum &number)
{
        ...
        auto increase = [](char a) { return (a != '.' ? a + 48 : a); };
        auto decrease = [](char a) { return (a != '.' ? a - 48 : a); };
 ...
 */
void bn_add(bignum &dest, const bignum &a, const bignum &b)
{
...
void bn_print(bignum &number)
{
        ...
        // decimal part
        for (size_t i = number.dpoint + 1; i < number.length; i++)
                std::cout << char(number.digits[i] + 48);
